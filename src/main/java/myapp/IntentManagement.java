...
public class IntentManagement {
  ...
  public static void createIntent(String displayName, String projectId,
    ...
    try (IntentsClient intentsClient = IntentsClient.create()) {
      ...
      for(String s : trainingPhrasesParts){
         parts.add(Part.newBuilder().setText(s).setEntityType("@company").setUserDefined(true).build());
      }
      trainingPhrases.add(
  ...
  public static void main(String[] args) throws Exception {
    System.setProperty("GRPC_PROXY_EXP", "127.0.0.1:1080");
    System.setProperty("GOOGLE_APPLICATION_CREDENTIALS_SKIP_APP_ENGINE","true");
    String method = "";
    String displayName = "";
    String intentId = "";
